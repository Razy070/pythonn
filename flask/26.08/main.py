...
def log_in(host=None, user=None, password=None, db_name=None):
...
def home(variable, host=None, user=None, password=None, db_name=None):
    # print("[INFO] Data was succefully inserted")
...
def home_post(host=None, user=None, password=None, db_name=None):
...
def home_delete(host=None, user=None, password=None, db_name=None):
    variable = request.form['variable']
    data_one = request.form['data_one']
    data_two = request.form['data_two']
    data_three = request.form['data_three']
...
def task_update(host=None, user=None, password=None, db_name=None):
    variable = request.form['variable']
    ...
    with connection.cursor() as cursor:
        cursor.execute(
            f"""UPDATE public.tasks SET title = '{data_one}', text = '{data_two}', data = '{data_three}' WHERE "user" 
            = '{data_six}' 
            and "id" = {data_five};""")
...
def new_task(variable, db_name=None, password=None, user=None, host=None):
